...
const fifteenHundos = inventors.filter(inventor => (inventor.year < 1600 && inventor.year >= 1500))
...
const mostYearsLived = [...inventors.sort((a, b) => a.passed - a.year > b.passed - b.year ? 1 : -1)]
console.table(mostYearsLived)
// 6. create a list of Boulevards in Paris that contain 'de' anywhere in the name
// https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris
// * Do this one in the browser on that page

// 7. sort Exercise
// Sort the people alphabetically by last name
const byLastName = people.sort((a, b) => {
    delimitter = ', ';
    const [aLastName, _aFirstName] = a.split(delimitter);
    const [bLastName, _bFirstName] = b.split(delimitter);
